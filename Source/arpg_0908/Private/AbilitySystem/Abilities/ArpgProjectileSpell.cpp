...
AArpgProjectile* UArpgProjectileSpell::SpawnProjectile(const FVector& ProjectileFacingLocation, bool ZeroPitch, const FGameplayTagContainer& InWithTags, const FGameplayTagContainer& InPassThroughTags,

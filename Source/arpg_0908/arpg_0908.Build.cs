...
public class arpg_0908 : ModuleRules
{
	public arpg_0908(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PrivateDependencyModuleNames.AddRange(new string[] { "GameplayTags", "GameplayTasks", "NavigationSystem", "Niagara", "AIModule", "OnlineSubsystem", "OnlineSubsystemNull", "OnlineSubsystemSteam", "LevelSequence", "MovieScene" });
